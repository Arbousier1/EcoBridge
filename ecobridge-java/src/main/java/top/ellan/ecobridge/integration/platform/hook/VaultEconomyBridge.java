 ...
 *
 * <p>Registers EcoBridge as a Vault economy provider, intercepting all
 * Vault-based economy calls and routing them through EcoBridge's transfer
 * regulator and CoinsEngine's actual balance store.
 *
 * <p>This ensures that ANY plugin using the Vault API (essentials, quests, jobs,
...
public class VaultEconomyBridge implements Economy {
    ...
    public VaultEconomyBridge(EcoBridge plugin) {
        ...
        this.primaryCurrency = CoinsEngineAPI.getCurrency(currencyId);
    }
    ...
    public static void register(EcoBridge plugin) {
        ...
        Bukkit.getServicesManager().register(
            Economy.class, bridge, plugin, ServicePriority.High);
    ...
    private double getBalance(UUID uuid) {
        ...
        return CoinsEngineAPI.getBalance(uuid, primaryCurrency);
    }
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer player, double amount) {
        ...
        if (tm != null && player.isOnline()) {
            ...
            CoinsEngineAPI.removeBalance(player.getUniqueId(), primaryCurrency, netWithdraw);
        ...
        CoinsEngineAPI.removeBalance(player.getUniqueId(), primaryCurrency, amount);
    ...
    public EconomyResponse depositPlayer(OfflinePlayer player, double amount) {
        ...
        CoinsEngineAPI.addBalance(player.getUniqueId(), primaryCurrency, amount);
    ...
    @Override
    public boolean createPlayerAccount(String playerName, String world) { return true; }
    @Override
    public boolean createPlayerAccount(OfflinePlayer player, String world) { return true; }

    @Override
    public String currencyNamePlural() { return primaryCurrency != null ? primaryCurrency.getName() : "coins"; }
    @Override
    public String currencyNameSingular() { return primaryCurrency != null ? primaryCurrency.getName() : "coin"; }
    ...
    @Override
    public boolean isEnabled() { return primaryCurrency != null; }
    @Override
    public String getName() { return "EcoBridge"; }
}
